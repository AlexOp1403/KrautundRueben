...
class SENDUNGZutatMiddleware extends BaseMiddleware {

  constructor(app) {
    super({
      app
    });
    this.permissions = require('./SENDUNG_ZUTAT.policy').permissions;
    // this.$acl = app.acl;
    // this.$acl.addPolicy(require('./SENDUNG_ZUTAT.policy').acl);
  }


  async default (req, res, next) {

    console.log('SENDUNGZutat middleware;')
...
module.exports = SENDUNGZutatMiddleware;