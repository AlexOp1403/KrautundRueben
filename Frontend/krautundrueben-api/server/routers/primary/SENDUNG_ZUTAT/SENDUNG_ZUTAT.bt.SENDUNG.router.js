...
class SENDUNGZutatBtSENDUNGRouter extends BaseRouter {

  constructor(app) {
    super(app);
    this.SENDUNGZutatMiddleware = app.$middlewares.primary.SENDUNGZutatMiddleware;
    this.SENDUNGZutatBtSENDUNGService = app.$services.primary.SENDUNGZutatBtSENDUNGService;
    this._mapRoutes(app.$router);
  }


  async belongs(req, res) {
    let data = await this.SENDUNGZutatBtSENDUNGService.belongsTo(req, res);
    res.json(data);
  }
...
module.exports = SENDUNGZutatBtSENDUNGRouter;