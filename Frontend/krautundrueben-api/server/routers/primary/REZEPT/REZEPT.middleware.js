...
class REZEPTMiddleware extends BaseMiddleware {

  constructor(app) {
    super({
      app
    });
    this.permissions = require('./REZEPT.policy').permissions;
    // this.$acl = app.acl;
    // this.$acl.addPolicy(require('./REZEPT.policy').acl);
  }


  async default (req, res, next) {

    console.log('REZEPT middleware;')
...
module.exports = REZEPTMiddleware;