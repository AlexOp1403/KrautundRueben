...
class BESTELLUNGMiddleware extends BaseMiddleware {

  constructor(app) {
    super({
      app
    });
    this.permissions = require('./BESTELLUNG.policy').permissions;
    // this.$acl = app.acl;
    // this.$acl.addPolicy(require('./BESTELLUNG.policy').acl);
  }


  async default (req, res, next) {

    console.log('BESTELLUNG middleware;')
...
module.exports = BESTELLUNGMiddleware;