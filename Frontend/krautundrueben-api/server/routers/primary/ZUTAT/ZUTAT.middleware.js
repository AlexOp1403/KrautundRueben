...
class ZUTATMiddleware extends BaseMiddleware {

  constructor(app) {
    super({
      app
    });
    this.permissions = require('./ZUTAT.policy').permissions;
    // this.$acl = app.acl;
    // this.$acl.addPolicy(require('./ZUTAT.policy').acl);
  }


  async default (req, res, next) {

    console.log('ZUTAT middleware;')
...
module.exports = ZUTATMiddleware;