...
class KUNDEMiddleware extends BaseMiddleware {

  constructor(app) {
    super({
      app
    });
    this.permissions = require('./KUNDE.policy').permissions;
    // this.$acl = app.acl;
    // this.$acl.addPolicy(require('./KUNDE.policy').acl);
  }


  async default (req, res, next) {

    console.log('KUNDE middleware;')
...
module.exports = KUNDEMiddleware;